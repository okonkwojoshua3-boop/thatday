export function ThatDayLogo({ className }: { className?: string }) {
  return (
    <div className={`flex items-center gap-1.5 sm:gap-2.5 ${className ?? ''}`}>
      <svg className="w-5 h-5 sm:w-[34px] sm:h-[34px] shrink-0" viewBox="0 0 34 34" fill="none" aria-hidden="true">
      ...
      <span className="text-[0.85rem] sm:text-[1.35rem] font-bold tracking-tight text-zinc-900 leading-none">
