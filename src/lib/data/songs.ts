...
const ngSongsByYear: Record<number, SongEntry> = {
  ...
  1994: { title: 'Shakomo', artist: 'Lagbaja' },
  1995: { title: 'Musical Conspiracy', artist: 'Lagbaja' },
  1996: { title: 'Ijo Fuji', artist: 'Wasiu Ayinde Marshal' },
  1997: { title: 'E Dey Do Me', artist: 'Femi Kuti' },
  1998: { title: 'Obalende', artist: 'Femi Kuti' },
  ...
  2002: { title: 'Unforgettable', artist: 'Plantashun Boiz' },
  2003: { title: 'Gongo Aso', artist: '9ice' },
  2004: { title: 'African Queen', artist: '2face Idibia' },
  2005: { title: 'Tongolo', artist: "D'banj" },
  2006: { title: 'Why Me', artist: "D'banj" },
  ...
  2010: { title: 'Holla at Your Boy', artist: 'Wizkid' },
  2011: { title: 'Dami Duro', artist: 'Davido' },
  2012: { title: 'Superstar', artist: 'Wizkid' },
  2013: { title: 'Skelewu', artist: 'Davido' },
  2014: { title: 'Aye', artist: 'Davido' },
  2015: { title: 'Godwin', artist: 'Korede Bello' },
  2016: { title: 'Dorobucci', artist: 'MAVIN All Stars' },
...
const zaSongsByYear: Record<number, SongEntry> = {
  ...
  1971: { title: 'Malaika', artist: 'Miriam Makeba' },
  1972: { title: 'Meadowlands', artist: 'Strike Vilakazi' },
  1973: { title: 'Wimoweh', artist: 'Miriam Makeba' },
  1974: { title: 'Pata Pata', artist: 'Miriam Makeba' },
  1975: { title: 'Grazing in the Grass', artist: 'Hugh Masekela' },
  1976: { title: 'Soweto Blues', artist: 'Miriam Makeba' },
  1977: { title: 'Coal Train (Stimela)', artist: 'Hugh Masekela' },
  1978: { title: 'Nomathemba', artist: 'Ladysmith Black Mambazo' },
  1979: { title: 'Homeless', artist: 'Ladysmith Black Mambazo' },
  1980: { title: 'Soweto Blues', artist: 'Miriam Makeba' },
  1981: { title: 'Jive Soweto', artist: 'Sipho Hotstix Mabuse' },
  1982: { title: 'Burnout', artist: 'Sipho Hotstix Mabuse' },
  1983: { title: 'Burnout', artist: 'Sipho Hotstix Mabuse' },
  1984: { title: 'Hi-Life', artist: 'Sipho Hotstix Mabuse' },
  1985: { title: 'Bring Him Back Home', artist: 'Hugh Masekela' },
  1986: { title: 'Slave', artist: 'Lucky Dube' },
  1987: { title: 'Graceland', artist: 'Paul Simon ft. Ladysmith Black Mambazo' },
  1988: { title: 'Together as One', artist: 'Lucky Dube' },
  1989: { title: 'Prisoner', artist: 'Lucky Dube' },
  1990: { title: 'Homeless', artist: 'Ladysmith Black Mambazo' },
  1991: { title: 'Soldier', artist: 'Lucky Dube' },
  1992: { title: 'Nomakanjani', artist: 'Yvonne Chaka Chaka' },
...
const brSongsByYear: Record<number, SongEntry> = {
  ...
  1961: { title: 'Bim Bom', artist: 'João Gilberto' },
  1962: { title: 'Desafinado', artist: 'João Gilberto' },
  1963: { title: 'Ela é Carioca', artist: 'Tom Jobim' },
  1964: { title: 'Arrastão', artist: 'Elis Regina' },
  1965: { title: 'Garota de Ipanema', artist: 'Tom Jobim' },
  1966: { title: 'A banda', artist: 'Chico Buarque' },
  1967: { title: 'Carolina', artist: 'Chico Buarque' },
  1968: { title: 'Tropicália', artist: 'Caetano Veloso' },
  1969: { title: 'Aquele Abraço', artist: 'Gilberto Gil' },
  1970: { title: 'Aquarela do Brasil', artist: 'Elis Regina' },
  1971: { title: 'Asa Branca', artist: 'Luiz Gonzaga' },
  1972: { title: 'Fado Tropical', artist: 'Chico Buarque & Ruy Guerra' },
  1973: { title: 'Cálice', artist: 'Chico Buarque & Milton Nascimento' },
  1974: { title: 'O Bêbado e a Equilibrista', artist: 'Elis Regina' },
  1975: { title: 'Como Nossos Pais', artist: 'Elis Regina' },
  1976: { title: 'Passaredo', artist: 'Elis Regina' },
  1977: { title: 'Maria Maria', artist: 'Milton Nascimento' },
  1978: { title: 'Caçador de Mim', artist: 'Milton Nascimento' },
  1979: { title: 'Amor Até o Fim', artist: 'Fagner' },
  1980: { title: 'Menina Veneno', artist: 'Ritchie' },
  1981: { title: 'Você Abusou', artist: 'MPB-4' },
  1982: { title: 'Mistério do Planeta', artist: 'Blitz' },
  1983: { title: 'Eu Vou Ficar', artist: 'Blitz' },
  1984: { title: 'Trem das Onze', artist: 'Demônios da Garoa' },
  1985: { title: 'Brasil', artist: 'Cazuza' },
  1986: { title: 'Ideologia', artist: 'Cazuza' },
  1987: { title: 'Faz Parte do Meu Show', artist: 'Cazuza' },
  1988: { title: 'O Tempo Não Para', artist: 'Cazuza' },
  1989: { title: 'Baby', artist: 'Caetano Veloso' },
  1990: { title: 'O Tempo Não Para', artist: 'Cazuza' },
  1991: { title: 'Preciso Me Encontrar', artist: 'Caetano Veloso' },
...
const inSongsByYear: Record<number, SongEntry> = {
  ...
  1961: { title: 'Teri Pyari Pyari Do Aankhein',    artist: 'Mohammed Rafi' },
  1962: { title: 'Lag Ja Gale',                     artist: 'Lata Mangeshkar' },
  1963: { title: 'Aaj Phir Jeene Ki Tamanna',       artist: 'Lata Mangeshkar' },
  1964: { title: 'Woh Jab Yaad Aaye',               artist: 'Lata Mangeshkar' },
  1965: { title: 'Mere Mehboob Qayamat Hogi',        artist: 'Mohammed Rafi' },
  1966: { title: 'Baharon Phool Barsao',            artist: 'Mohammed Rafi' },
  1967: { title: 'Abhi Na Jao Chhod Kar',           artist: 'Mohammed Rafi & Asha Bhosle' },
  1968: { title: 'Dil Ka Bhanwar Kare Pukar',       artist: 'Mohammed Rafi' },
  1969: { title: 'Mere Sapnon Ki Rani',             artist: 'Kishore Kumar' },
  1970: { title: 'Roop Tera Mastana',                artist: 'Kishore Kumar' },
  1971: { title: 'Zindagi Ek Safar Hai Suhana',     artist: 'Kishore Kumar' },
  1972: { title: 'Yeh Shaam Mastani',               artist: 'Kishore Kumar' },
  1973: { title: 'Rote Hue Aate Hain Sab',          artist: 'Mukesh' },
  1974: { title: 'Ek Ajnabee Haseena Se',           artist: 'Kishore Kumar' },
  1975: { title: 'Dum Maro Dum',                     artist: 'Asha Bhosle' },
  1976: { title: 'Aap Ki Aankhon Mein',             artist: 'Kishore Kumar & Lata Mangeshkar' },
  1977: { title: 'Pag Ghungroo Bandh',              artist: 'Lata Mangeshkar' },
  1978: { title: 'Aap Jaisa Koi',                    artist: 'Nazia Hassan' },
  1979: { title: 'Teri Aankhon Ke Siva',            artist: 'Lata Mangeshkar' },
  1980: { title: 'Om Shanti Om',                     artist: 'Nazia Hassan & Biddu' },
  1981: { title: 'Ek Duje Ke Liye',                 artist: 'S.P. Balasubrahmanyam' },
  1982: { title: 'Dard-E-Dil',                      artist: 'Mohammed Rafi' },
  1983: { title: 'Tere Bina Zindagi Se',            artist: 'Lata Mangeshkar' },
  1984: { title: 'Tujhse Naraz Nahin Zindagi',      artist: 'Lata Mangeshkar' },
  1985: { title: 'Pyar Mein Dil Pe',                 artist: 'Lata Mangeshkar' },
  1986: { title: 'Pyar Ka Dard Hai',                artist: 'Lata Mangeshkar & Udit Narayan' },
  1987: { title: 'Mere Kwabon Mein Jo Aaye',        artist: 'Lata Mangeshkar' },
  1988: { title: 'Ek Do Teen',                       artist: 'Alka Yagnik' },
  1989: { title: 'Dil Hai Ke Manta Nahin',          artist: 'Kumar Sanu & Anuradha Paudwal' },
  1990: { title: 'Aaja Shaam Hone Aayi',            artist: 'Lata Mangeshkar' },
  1991: { title: 'Dil Hai Ke Manta Nahin',           artist: 'Kumar Sanu & Anuradha Paudwal' },
  1992: { title: 'Choli Ke Peeche',                 artist: 'Alka Yagnik & Ila Arun' },
  1993: { title: 'Tip Tip Barsa Paani',             artist: 'Udit Narayan & Alka Yagnik' },
  ...
  1996: { title: 'Maahi Ve',                        artist: 'Sukhwinder Singh & Kavita Krishnamurthy' },
  ...
  1999: { title: 'Woh Lamhe Woh Baatein',           artist: 'Shaan' },
  ...
  2002: { title: 'Kal Ho Naa Ho',                   artist: 'Sonu Nigam' },
  2003: { title: 'Kal Ho Naa Ho',                    artist: 'Sonu Nigam' },
  2004: { title: 'Tumhi Dekho Naa',                 artist: 'Udit Narayan & Alka Yagnik' },
  2005: { title: 'Kajra Re',                        artist: 'Shankar Mahadevan, Javed Ali & Alka Yagnik' },
...
const caSongsByYear: Record<number, SongEntry> = {
  ...
  1974: { title: 'Seasons in the Sun',               artist: 'Terry Jacks' },
  1975: { title: 'Love Will Keep Us Together',       artist: 'Captain & Tennille' },
  1976: { title: 'Disco Duck',                       artist: 'Rick Dees' },
  1977: { title: 'You Light Up My Life',             artist: 'Debby Boone' },
  1978: { title: 'Shadow Dancing',                   artist: 'Andy Gibb' },
  1979: { title: 'My Sharona',                       artist: 'The Knack' },
  1980: { title: 'Call Me',                          artist: 'Blondie' },
...
const auSongsByYear: Record<number, SongEntry> = {
  ...
  1971: { title: 'My Sweet Lord',                    artist: 'George Harrison' },
  1972: { title: 'Amazing Grace',                    artist: 'Royal Scots Dragoon Guards' },
  1973: { title: 'The Most Beautiful Girl',           artist: 'Charlie Rich' },
  1974: { title: 'Tiger Feet',                       artist: 'Mud' },
  1975: { title: 'Love Will Keep Us Together',       artist: 'Captain & Tennille' },
  1976: { title: 'Save Your Kisses for Me',          artist: 'Brotherhood of Man' },
  1977: { title: 'How Deep Is Your Love',            artist: 'Bee Gees' },
  1978: { title: 'Night Fever',                      artist: 'Bee Gees' },
  1979: { title: 'Heart of Glass',                   artist: 'Blondie' },
  1980: { title: 'Another Brick in the Wall',        artist: 'Pink Floyd' },
  1981: { title: 'Physical',                         artist: 'Olivia Newton-John' },
  1982: { title: 'Eye of the Tiger',                 artist: 'Survivor' },
  1983: { title: 'Come On Eileen',                   artist: 'Dexys Midnight Runners' },
  1984: { title: 'When Doves Cry',                   artist: 'Prince' },
  1985: { title: 'We Are the World',                 artist: 'USA for Africa' },
...
const deSongsByYear: Record<number, SongEntry> = {
  ...
  1961: { title: 'Rote Lippen soll man küssen',      artist: 'Cliff Richard' },
  1962: { title: 'Ich will keinen Mann',             artist: 'Lolita' },
  1963: { title: 'She Loves You',                    artist: 'The Beatles' },
  1964: { title: 'I Want to Hold Your Hand',         artist: 'The Beatles' },
  1965: { title: '(I Can\'t Get No) Satisfaction',   artist: 'The Rolling Stones' },
  1966: { title: 'Ballad of the Green Berets',       artist: 'Staff Sgt. Barry Sadler' },
  1967: { title: 'Release Me',                       artist: 'Engelbert Humperdinck' },
  1968: { title: 'Hey Jude',                         artist: 'The Beatles' },
  1969: { title: 'Sugar Sugar',                      artist: 'The Archies' },
  1970: { title: 'In the Summertime',                artist: 'Mungo Jerry' },
  ...
  1974: { title: 'Seasons in the Sun',               artist: 'Terry Jacks' },
  1975: { title: 'Bohemian Rhapsody',                artist: 'Queen' },
  1976: { title: 'Fernando',                         artist: 'ABBA' },
  1977: { title: "Don't Give Up on Us",              artist: 'David Soul' },
  1978: { title: 'Rivers of Babylon',                artist: 'Boney M' },
  1979: { title: 'Heart of Glass',                   artist: 'Blondie' },
  1980: { title: 'Call Me',                          artist: 'Blondie' },
  ...
  1985: { title: 'We Are the World',                 artist: 'USA for Africa' },
  1986: { title: 'Rock Me Amadeus',                  artist: 'Falco' },
  1987: { title: 'La Isla Bonita',                   artist: 'Madonna' },
  1988: { title: 'Faith',                            artist: 'George Michael' },
  ...
  1998: { title: 'Believe',                          artist: 'Cher' },
  1999: { title: '...Baby One More Time',            artist: 'Britney Spears' },
  2000: { title: 'Be with You',                      artist: 'Enrique Iglesias' },
  2001: { title: 'Hanging by a Moment',              artist: 'Lifehouse' },
  2002: { title: 'The Ketchup Song',                 artist: 'Las Ketchup' },
  2003: { title: 'Beautiful',                        artist: 'Christina Aguilera' },
  2004: { title: 'Yeah!',                            artist: 'Usher' },
  2005: { title: 'Hung Up',                          artist: 'Madonna' },
...
const frSongsByYear: Record<number, SongEntry> = {
  ...
  1961: { title: 'Les Succès de l\'année',           artist: 'Luis Mariano' },
  1962: { title: 'Milord',                           artist: 'Édith Piaf' },
  1963: { title: 'She Loves You',                    artist: 'The Beatles' },
  1964: { title: 'I Want to Hold Your Hand',         artist: 'The Beatles' },
  1965: { title: 'La Bohème',                        artist: 'Charles Aznavour' },
  1966: { title: 'A banda',                          artist: 'Chico Buarque' },
  1967: { title: 'Il faut savoir',                   artist: 'Charles Aznavour' },
  1968: { title: 'Hey Jude',                         artist: 'The Beatles' },
  1969: { title: 'Je t\'aime… moi non plus',         artist: 'Serge Gainsbourg & Jane Birkin' },
  1970: { title: 'Les Champs-Élysées',               artist: 'Joe Dassin' },
  1971: { title: 'Une Belle Histoire',               artist: 'Michel Fugain' },
  1972: { title: 'La Maladie d\'Amour',              artist: 'Michel Sardou' },
  1973: { title: 'J\'ai la musique en tête',         artist: 'Herbert Léonard' },
  1974: { title: 'Laisse-Moi t\'Aimer',             artist: 'Mike Brant' },
  1975: { title: "L'Été indien",                     artist: 'Joe Dassin' },
  1976: { title: 'Fernando',                         artist: 'ABBA' },
  1977: { title: 'La Vie en Rose',                   artist: 'Grace Jones' },
  1978: { title: 'Rivers of Babylon',                artist: 'Boney M' },
  1979: { title: 'Le Freak',                         artist: 'Chic' },
  1980: { title: 'Et si tu n\'existais pas',          artist: 'Joe Dassin' },
  1981: { title: 'Femme Je Vous Aime',               artist: 'Julien Clerc' },
  1982: { title: 'Come On Eileen',                   artist: 'Dexys Midnight Runners' },
  1983: { title: 'Karma Chameleon',                  artist: 'Culture Club' },
  1984: { title: "Do They Know It's Christmas?",     artist: 'Band Aid' },
  1985: { title: 'Saga Africa',                      artist: 'Yannick' },
  1986: { title: 'Voyage Voyage',                    artist: 'Desireless' },
  1987: { title: 'La Déclaration d\'Amour',          artist: 'France Gall' },
  1988: { title: 'Sans Contrefaçon',                 artist: 'Mylène Farmer' },
  1989: { title: 'Lambada',                          artist: 'Kaoma' },
  1990: { title: 'Dès que le vent soufflera',        artist: 'Renaud' },
  1991: { title: '(Everything I Do) I Do It for You', artist: 'Bryan Adams' },
  1992: { title: 'I Will Always Love You',           artist: 'Whitney Houston' },
  1993: { title: "I'd Do Anything for Love (But I Won't Do That)", artist: 'Meat Loaf' },
  1994: { title: 'The Sign',                         artist: 'Ace of Base' },
  ...
  2001: { title: 'Je l\'aime à mourir',              artist: 'Shakira' },
  2002: { title: 'The Ketchup Song',                 artist: 'Las Ketchup' },
  2003: { title: 'Beautiful',                        artist: 'Christina Aguilera' },
...
const jpSongsByYear: Record<number, SongEntry> = {
  ...
  1976: { title: 'Kamen Butoukai',                   artist: 'Alice' },
  1977: { title: 'Jounetsu no Arashi',               artist: 'Nishida Hikaru' },
  1978: { title: 'UFO',                              artist: 'Pink Lady' },
  1979: { title: 'Southpaw',                         artist: 'Pink Lady' },
  1980: { title: 'Yume de Aetara',                   artist: 'Hiromi Ōta' },
  1981: { title: 'Yokohama Twilight Time',            artist: 'Seiko Matsuda' },
  1982: { title: 'Hadashi no Kisetsu',               artist: 'Seiko Matsuda' },
  1983: { title: 'Swimmer',                          artist: 'Seiko Matsuda' },
  1984: { title: 'Rock\'n Rouge',                    artist: 'Seiko Matsuda' },
  1985: { title: 'CHA-CHA-CHA',                      artist: 'Ichikawa Ikue' },
  1986: { title: 'DESIRE -Jounetsu-',                artist: 'Nakamori Akina' },
  1987: { title: 'Nanka Ii Koto Arisou na Machi e',  artist: 'Anzen Chitai' },
  1988: { title: 'Donna Toki mo',                    artist: 'Anzen Chitai' },
  1989: { title: 'Dakishimetai',                     artist: 'Yutaka Ozaki' },
  1990: { title: 'Oh! Yeah!',                        artist: 'Anzen Chitai' },
  1991: { title: 'SAY YES',                          artist: 'Chage & Aska' },
  1992: { title: 'Donna Ni Hanarete Ite Mo',         artist: 'Chage & Aska' },
  1993: { title: 'Yoru no Yuki',                     artist: 'Chage & Aska' },
  1994: { title: 'Hello, Again ~Mukashi kara Aru Basho~', artist: 'MY LITTLE LOVER' },
  1995: { title: 'LOVE LOVE LOVE / Goodbye My Loneliness', artist: 'DREAMS COME TRUE' },
  1996: { title: 'Don\'t You See!',                  artist: 'Globe' },
  1997: { title: 'Speed Thrill',                     artist: 'Speed' },
  1998: { title: 'my graduation',                    artist: 'SPEED' },
  1999: { title: 'Automatic',                        artist: 'Hikaru Utada' },
  2000: { title: 'Tsunami',                          artist: 'Southern All Stars' },
  2001: { title: 'Can You Keep a Secret?',           artist: 'Hikaru Utada' },
  2002: { title: 'Sekai ga Owaru Made wa',           artist: 'WANDS' },
  2003: { title: 'Sekai ni Hitotsu Dake no Hana',    artist: 'SMAP' },
  2004: { title: 'Joshuu 0ban',                      artist: 'SMAP' },
  2005: { title: 'Kansha Kangeki Ame Arare',         artist: 'Arashi' },
  2006: { title: 'Love So Sweet',                    artist: 'Arashi' },
  2007: { title: 'Flavor of Life',                   artist: 'Hikaru Utada' },
  2008: { title: 'Prisoner of Love',                 artist: 'Hikaru Utada' },
  2009: { title: 'Believe / Kumori Nochi, Kaisei',   artist: 'Arashi' },
...
const keSongsByYear: Record<number, SongEntry> = {
  ...
  1971: { title: 'Malaika',                          artist: 'Fadhili William' },
  1972: { title: 'Benga Beat',                       artist: 'Daniel Owino Misiani' },
  1973: { title: 'Kayanda',                          artist: 'Daniel Owino Misiani' },
  1974: { title: 'Disco Matanga',                    artist: 'Daniel Owino Misiani' },
  1975: { title: 'Shauri Yako',                      artist: 'Orchestra Virunga' },
  1976: { title: 'Angelike',                         artist: 'Daniel Owino Misiani' },
  1977: { title: 'Sina Makosa',                      artist: 'Les Wanyika' },
  1978: { title: 'Pole Musa',                        artist: 'Orchestra Virunga' },
  1979: { title: 'Naomba Radhi',                     artist: 'Les Wanyika' },
  1980: { title: 'Mama Africa',                      artist: 'Fadhili William' },
  1981: { title: 'Jambo Bwana',                      artist: 'Them Mushrooms' },
  1982: { title: 'Karibu Nyumbani',                  artist: 'Them Mushrooms' },
  1983: { title: 'Waweza',                           artist: 'Them Mushrooms' },
  1984: { title: 'Nakupenda',                        artist: 'Ayub Ogada' },
  1985: { title: 'Nakupenda',                        artist: 'Ayub Ogada' },
  1986: { title: 'Mambo Bado',                       artist: 'Orchestra Super Mazembe' },
  1987: { title: 'Nchi ya Kitu Kidogo',              artist: 'Eric Wainaina' },
  1988: { title: 'Jambo Kenya',                      artist: 'Kamaru' },
  1989: { title: 'Sina Makosa',                      artist: 'Kamaru' },
  1990: { title: 'Harambee',                         artist: 'Them Mushrooms' },
  1991: { title: 'Nenda Mbali',                      artist: 'Kamaru' },
  1992: { title: 'Waza Waza',                        artist: 'Them Mushrooms' },
  1993: { title: 'Atoti',                            artist: 'Them Mushrooms' },
  1994: { title: 'Sawa Sawa',                        artist: 'Eric Wainaina' },
  1995: { title: 'Dunia Ina Mambo',                  artist: 'Orchestra Super Mazembe' },
  1996: { title: 'Mwana Mwana',                      artist: 'Suzanna Owiyo' },
  1997: { title: 'Kenya Only',                       artist: 'Eric Wainaina' },
  1998: { title: 'Nchi ya Kitu Kidogo',              artist: 'Eric Wainaina' },
  1999: { title: 'Dunia Ina Mambo',                  artist: 'Eric Wainaina' },
  2000: { title: 'Ombeni',                           artist: 'Suzanna Owiyo' },
  2001: { title: 'Malaika',                          artist: 'Suzanna Owiyo' },
  2002: { title: 'Zunguuka',                         artist: 'Suzanna Owiyo' },
  2003: { title: 'Unbwogable',                       artist: 'Gidi Gidi Maji Maji' },
  2004: { title: 'Nasikia',                          artist: 'Suzanna Owiyo' },
  2005: { title: 'Bidii Yangu',                      artist: 'Nyota Ndogo' },
  2006: { title: 'Kamua Leo',                        artist: 'Nonini ft. Nazizi' },
  2007: { title: 'My Life',                          artist: 'Nonini' },
  2008: { title: 'Njia Panda',                       artist: 'Nameless' },
  2009: { title: 'Mungu Pekee',                      artist: 'Sauti Sol' },
  2010: { title: 'Leo ni Leo',                       artist: 'Sauti Sol' },
  2011: { title: 'Nishike',                          artist: 'Sauti Sol' },
  2012: { title: 'Nishike',                          artist: 'Sauti Sol' },
  2013: { title: 'Isabella',                         artist: 'Sauti Sol' },
  2014: { title: 'Sura Yako',                        artist: 'Sauti Sol' },
  2015: { title: 'Nerea',                            artist: 'Sauti Sol' },
...
const ghSongsByYear: Record<number, SongEntry> = {
  ...
  1971: { title: 'Ghana Freedom',                   artist: 'E.T. Mensah' },
  1972: { title: 'Twe Twe Twe',                     artist: 'E.T. Mensah' },
  1973: { title: 'Obiaa Yere Wo Hen',               artist: 'A.B. Crentsil' },
  1974: { title: 'Highlife Tonight',                artist: 'Ebo Taylor' },
  1975: { title: 'Love and Death',                  artist: 'Ebo Taylor' },
  1976: { title: 'Come Along',                      artist: 'Ebo Taylor' },
  1977: { title: 'Moses',                           artist: 'A.B. Crentsil' },
  1978: { title: 'Angelina',                        artist: 'A.B. Crentsil' },
  1979: { title: 'Sweet Talks',                     artist: 'Pat Thomas' },
  1980: { title: 'Ohia',                            artist: 'E.T. Mensah' },
  1981: { title: 'Obra',                            artist: 'Nana Ampadu' },
  1982: { title: 'Onipa Hia Moa',                   artist: 'Nana Ampadu' },
  1983: { title: 'Odo Ye Wu',                       artist: 'Kojo Antwi' },
  1984: { title: 'Obi Baa Sika',                    artist: 'Kojo Antwi' },
  1985: { title: 'Sankwuaa',                        artist: 'Kojo Antwi' },
  1986: { title: 'Odo Pa',                          artist: 'Nana Ampadu' },
  1987: { title: 'Odo Nti',                         artist: 'Kojo Antwi' },
  1988: { title: 'Mmaa Nnua',                       artist: 'Kojo Antwi' },
  1989: { title: 'Odo Pa Oo',                       artist: 'Kojo Antwi' },
  1990: { title: 'Oye',                             artist: 'Kojo Antwi' },
  1991: { title: 'Meka',                            artist: 'Daddy Lumba' },
  1992: { title: 'Agyanka Dabre',                   artist: 'Daddy Lumba' },
  1993: { title: 'Aben Wo Ha',                      artist: 'Daddy Lumba' },
  1994: { title: 'Daakye Asem',                     artist: 'Daddy Lumba' },
  1995: { title: 'Mepa Wo Kyew',                    artist: 'Daddy Lumba' },
  1996: { title: 'Wo Nkoa Ara',                     artist: 'Daddy Lumba' },
  1997: { title: 'Aben Wo Ha',                      artist: 'Daddy Lumba' },
  1998: { title: 'Gyae Su',                         artist: 'Daddy Lumba' },
  1999: { title: 'Dada Ba',                         artist: 'Amakye Dede' },
  2000: { title: 'Odo',                             artist: 'Daddy Lumba' },
  2001: { title: 'My Love',                         artist: 'Ofori Amponsah' },
  2002: { title: 'Otoolege',                        artist: 'Ofori Amponsah' },
  2003: { title: 'Odo Bra',                         artist: 'Ofori Amponsah' },
  2004: { title: 'Antie Janet',                     artist: 'Ofori Amponsah' },
  2005: { title: 'Kokooko',                         artist: 'Ofori Amponsah' },
  2006: { title: 'Too Sharp',                       artist: 'R2Bees' },
  2007: { title: 'Adom',                            artist: 'Ofori Amponsah' },
  2008: { title: 'Kae',                             artist: 'Sarkodie ft. Mugeez' },
  2009: { title: 'Baby',                            artist: 'Sarkodie ft. E.L.' },
  2010: { title: 'My Lady',                         artist: 'Sarkodie ft. E.L.' },
  2011: { title: 'Adonai',                          artist: 'Sarkodie ft. Castro' },
  2012: { title: 'Adonai',                          artist: 'Sarkodie ft. Castro' },
  2013: { title: 'Non Living Thing',                artist: 'Sarkodie' },
  2014: { title: 'Atia',                            artist: 'Sarkodie' },
  2015: { title: 'Ofie Nipa',                       artist: 'KiDi' },
  2016: { title: 'Say Cheese',                      artist: 'Shatta Wale' },
  2017: { title: 'Melanin',                         artist: 'Patoranking ft. Sarkodie' },
...
async function fetchAlbumArt(title: string, artist: string): Promise<string | undefined> {
  ...
  // Strategy 2: iTunes title-only (helps non-Latin / regional songs)
  try {
  ...
  // Strategy 3: Last.fm track.getInfo (uses existing API key)
  const apiKey = process.env.LASTFM_API_KEY
  if (apiKey) {
    try {
      const res = await fetch(
        `https://ws.audioscrobbler.com/2.0/?method=track.getInfo&api_key=${apiKey}&artist=${encodeURIComponent(artist)}&track=${encodeURIComponent(title)}&format=json&autocorrect=1`,
        { next: { revalidate: 86400 } },
      )
      if (res.ok) {
        const data = await res.json()
        const images: Array<{ size: string; '#text': string }> = data.track?.album?.image ?? []
        const img = images.find(i => i.size === 'extralarge') ?? images.find(i => i.size === 'large')
        const url = img?.['#text']
        // Last.fm returns a transparent placeholder for missing art — skip it
